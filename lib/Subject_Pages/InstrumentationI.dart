...
class InstrumentationI extends StatelessWidget {
  ...
  InstrumentationI({this.initialTabIndex = 0});
  @override
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          SubSection(
              text: 'AC bridge & measurement of Inductance and Capacitance'),
          ...
          SectionHeader(
              text: 'Electrical Signal Processing and transmission(6 hours)'),
          ...
          SubSection(
              text: 'Effect of noise, analog filtering, digital filtering'),
          SubSection(
              text:
                  'Optical communication, fibre optics, electro-optic conversion devices'),

          SectionHeader(
              text: 'Analog-Digital and Digital-Analog Conversion(6 hours)'),
