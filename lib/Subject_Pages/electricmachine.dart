...
class ElectricalMachine extends StatelessWidget {
  ...
  Widget _buildSyllabusTab() {
    ...
    SubSection(text: 'Faraday’s Law of Electromagnetic Induction, Statically and Dynamically Induced EMF'),
...
SectionHeader(text: 'Transformer (8 hours)'),
    ...
    SubSection(text: 'Tests: Polarity Test, Open Circuit test, Short Circuit test and Equivalent Circuit Parameters'),
    SubSection(text: 'Voltage Regulation'),
    SubSection(text: 'Losses in a transformer'),
    SubSection(text: 'Efficiency, condition for maximum efficiency and all day efficiency'),
    SubSection(text: 'Instrument Transformers: Potential Transformer (PT) and Current Transformer (CT)'),
    SubSection(text: 'Auto transformer: construction, working principle and Cu saving'),
...
SectionHeader(text: 'DC Generator (6 hours)'),
    ...
    SubSection(text: 'Method of excitation: separately and self excited, Types of DC Generator'),
    SubSection(text: 'Characteristics of series, shunt and compound generator'),
...
SectionHeader(text: 'DC Motor (6 hours)'),
    ...
    SubSection(text: 'Starting of D.C. Motors: 3 point and 4 point starters'),
    SubSection(text: 'Speed control of D.C. motors: Field Control, Armature Control'),
...
SectionHeader(text: 'Three Phase Induction Machines (6 hours)'),
    ...
    SubSection(text: 'Operating Principle, Rotating Magnetic Field, Synchronous Speed, Slip, Induced EMF, Rotor Current and its frequency, Torque Equation'),
    SubSection(text: 'Torque-Slip characteristics'),
    SubSection(text: 'Three Phase Induction Generator'),
    SubSection(text: 'Working Principle, voltage build up in an Induction Generator'),
...
SectionHeader(text: 'Three Phase Synchronous Machines (6 hours)'),
    ...
    SubSection(text: 'Constructional Details, Armature Windings, Types of Rotor, Exciter'),
...
SectionHeader(text: 'Fractional Kilowatt Motors (6 hours)'),
    SubSection(text: 'Single phase Induction Motors: Construction and Characteristics'),
    ...
    SubSection(text: 'Alternating Current Series motor and Universal motor'),
    SubSection(text: 'Special Purpose Machines: Stepper motor, Schrage motor and Servo motor'),
...
SectionHeader(text: 'References'),
    SubSection(text: 'I.J. Nagrath & D.P.Kothari,” Electrical Machines”, Tata McGraw Hill'),
    SubSection(text: 'S. K. Bhattacharya, “Electrical Machines”, Tata McGraw Hill'),
    SubSection(text: 'B. L. Theraja and A. K. Theraja, “Electrical Technology (Vol-II)”, S. Chand'),
    SubSection(text: 'Husain Ashfaq ,” Electrical Machines”, Dhanpat Rai & Sons'),
    SubSection(text: 'A.E. Fitzgerald, C.Kingsley Jr and Stephen D. Umans,”Electric Machinery”, Tata McGraw Hill'),
    SubSection(text: 'B.R. Gupta & Vandana Singhal, “Fundamentals of Electrical Machines, New Age International'),
    SubSection(text: 'P. S. Bhimbra, “Electrical Machines”’ Khanna Publishers'),
    SubSection(text: 'Irving L.Kosow, “Electric Machine and Tranformers”, Prentice Hall of India.'),
    SubSection(text: 'M.G. Say, “The Performance and Design of AC machines”, Pit man & Sons.'),
    SubSection(text: 'Bhag S. Guru and Huseyin R. Hizirogulu, “Electric Machinery and Transformers” Oxford University Press, 2001.')
