...
class Microprocessor extends StatelessWidget {
  ...
  Widget _buildSyllabusTab() {
    ...
    SubSection(text: 'Microinstructions and Hardwired/Microprogrammed Control Unit'),
...
SectionHeader(text: 'Programming with 8085 Microprocessor(10 hours)'),
    SubSection(text: 'Internal Architecture and Features of 8085 microprocessor'),
    ...
    SubSection(text: 'Simple Programs with Arithmetic and Logical Operations'),
...
SectionHeader(text: 'Programming with 8086 Microprocessor(12 hours)'),
    SubSection(text: 'Internal Architecture and Features of 8086 Microprocessor'),
    ...
    SubSection(text: 'Simple Programs for Arithmetic, Logical, String Input/Output'),
    SubSection(text: 'Conditions and Loops'),
    SubSection(text: 'Array and String Processing'),
    SubSection(text: 'Read and Display ASCII and Decimal Numbers'),
    SubSection(text: 'Displaying Numbers in Binary and Hexadecimal Formats'),

SectionHeader(text: 'Microprocessor System(10 hours)'),
    SubSection(text: 'Pin Configuration of 8085 and 8086 Microprocessors'),
    SubSection(text: 'Bus Structure'),
    SubSection(text: 'Synchronous Bus'),
    SubSection(text: 'Asynchronous Bus'),
    SubSection(text: 'Read and Write Bus Timing of 8085 and 8086 Microprocessors'),
    ...
    SubSection(text: 'I/O Address Decoding with NAND and Block Decoders (8085, 8086)'),
    SubSection(text: 'Memory Address Decoding with NAND, Block and PROM Decoders (8085, 8086)'),
    SubSection(text: 'Parallel Interface'),
    SubSection(text: 'Modes: Simple, Wait, Single Handshaking and Double Handshaking'),
    SubSection(text: 'Introduction to Programmable Peripheral Interface (PPI)'),
    SubSection(text: 'Serial Interface'),
    SubSection(text: 'Synchronous and Asynchronous Transmission'),
    SubSection(text: 'Serial Interface Standards: RS232, RS423, RS422, USB'),
    SubSection(text: 'Introduction to USART'),
    SubSection(text: 'Introduction to Direct Memory Access (DMA) and DMA Controllers'),
...
SectionHeader(text: 'Advanced Topics(4 hours)'),
    ...
    SubSection(text: 'Instruction Level, Thread Level and Process Level Parallelism'),
    SubSection(text: 'Interprocess Communication, Resource Allocation and Deadlock'),
...
SectionHeader(text: 'Practical:'),
    SubSection(text: 'There will be about 12 lab exercises to program 8085 and 8086 microprocessors.'),

SectionHeader(text: 'References'),
    SubSection(text: 'Ramesh S. Gaonkar, “Microprocessor Architecture, Programming and Application with 8085”, 5th Edition 2002, Prentice Hall'),
    SubSection(text: 'Peter Abel, “IBM PC Assembly Language and Programming”, 5th Edition 2001, Pearson Education Inc.'),
    SubSection(text: 'D. V. Hall, “Microprocessor and Interfacing, Programming and Hardware”, 2nd Edition 1999, Tata McGraw Hill'),
    SubSection(text: 'John Uffenbeck, “Microcomputers and Microprocessors, The 8080, 8085 and Z-80 Programming, Interfacing and Troubleshooting” 3rd Edition 1999, Prentice Hall'),
    SubSection(text: 'Walter A. Triebel and Avtar Singh, “The 8088 and 8086 Microprocessors, Programming, Interfacing, Software, Hardware and Applications”, 4th Edition 2003, Prentice Hall'),
    SubSection(text: 'William Stalling, “Computer Organization and Architecture”, 8th Edition 2009, Prentice Hall')
