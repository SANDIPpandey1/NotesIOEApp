...
SectionHeader(text: 'Data Models [7 hours]'),
    ...
    SubSection(text: 'Alternate Data Model (hierarchical, network, graph)'),

SectionHeader(text: 'Relational Languages and Relational Model [7 hours]'),
...
SectionHeader(text: 'Database Constraints and Normalization [6 hours]'),
    ...
    SubSection(text: 'Different Normal Forms (1st, 2nd, 3rd, BCNF, DKNF)'),
...
SectionHeader(text: 'Transactions processing and Concurrency Control [6 hours]'),
...
SectionHeader(text: 'Advanced database Concepts [4 hours]'),
    SubSection(text: 'Concept of Object-Oriented and Distributed Database Model'),
...
SectionHeader(text: 'Practical:'),
    SubSection(text: 'Introduction and operations of MS-Access or MySQL or any suitable DBMS'),
    SubSection(text: 'Database Server Installation and Configuration (MS-SQLServer, Oracle)'),
    SubSection(text: 'DB Client Installation and Connection to DB Server. Introduction and practice with SELECT Command with the existing DB.'),
    SubSection(text: 'Further Practice with DML Commands'),
    SubSection(text: 'Practice with DDL Commands. (Create Database and Tables).'),
    SubSection(text: 'Practice of Procedure/Trigger and DB Administration & other DBs (MySQL, PG-SQL, DB2.)'),
    SubSection(text: 'Group Project Development.'),
    SubSection(text: 'Project Presentation and Viva'),

SectionHeader(text: 'References'),
    SubSection(text: 'H. F. Korth and A. Silberschatz, "Database system concepts", McGraw Hill, 2010.'),
    SubSection(text: 'A. K. Majumdar and P. Bhattacharaya, "Database Management Systems", Tata McGraw Hill, India, 2004.')
