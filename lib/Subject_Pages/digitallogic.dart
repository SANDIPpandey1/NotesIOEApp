...
SectionHeader(text: 'Sequential Machines(8 hours)'),
    ...
    SubSection(text: 'Hazards in Asynchronous System and Use of Redundant Branch'),
...
SectionHeader(text: 'Applications(2 hours)'),
    ...
    SubSection(text: 'DeMorgan’s law and it’s familiarization with NAND and NOR gates'),
    SubSection(text: 'Encoder, Decoder, and Multiplexer'),
    SubSection(text: 'Familiarization with Binary Addition and Subtraction'),
    ...
    SubSection(text: 'Familiarization with computer package for logic circuit design'),
    SubSection(text: 'Design digital circuits using hardware and software tools'),
    SubSection(text: 'Use of PLAs and PLDs'),

SectionHeader(text: 'References:'),
    SubSection(text: 'Donald P. Leach, Albert Paul Malvino and  Goutam Saha, “ Digital Principles and Applications”, 6th edition , Tata McGraw-Hill, 2006'),
    SubSection(text: 'David  J Comer “Digital Logic And State Machine Design” 3rd edition, Oxfored University Press, 2002'),
    SubSection(text: 'William I. Fletcher “An Engineering Approach  to Digital Design” Printice Hall of India, New Delhi 1990'),
    SubSection(text: 'William H. Gothmann, “Digital Electronics, An Introduction to Theory and Practice”, 2nd edition, PHI, 2009')
