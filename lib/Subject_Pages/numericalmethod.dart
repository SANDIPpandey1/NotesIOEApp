...
class NumericalMethod extends StatelessWidget {
  ...
  NumericalMethod({this.initialTabIndex = 0});
  @override
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          SubSection(
              text: 'Rate of Convergence and comparisons of these Methods'),
          ...
          SubSection(
              text: 'Iterative methods (Jacobi method, Gauss-Seidel method)'),
          ...
          SectionHeader(
              text: 'Numerical Differentiation and Integration(6 hours)'),
          ...
          SectionHeader(
              text: 'Solution of ordinary differential equations(6 hours)'),
          ...
          SubSection(
              text: 'Solution of Elliptic equation by Relaxation Method'),
          SubSection(
              text:
