...
SectionHeader(text: 'Verification and validation of simulation models (3 hours)'),
...
SectionHeader(text: 'References:'),
    SubSection(text: 'Jerry Banks, John S. Carson II, Barry L. Nelson, Devid M. Nicol, P. Shahabudeen: Discrete-Event system simulation'),
    SubSection(text: 'Geoffrey Gordon: System Simulation'),
    SubSection(text: 'A.M. Law and W.D. Kelton: Simulation and Modeling and analysis'),
    SubSection(text: 'R. Y. Rubinstein, B. Melamed: Modern Simulation and Modeling'),
