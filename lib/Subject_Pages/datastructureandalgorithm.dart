    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          SubSection(
              text: 'Tree traversals (pre-order, post-order and in-order)'),
          ...
          SubSection(
              text: 'Asymptotic notations: notations and their properties'),
          ...
          SubSection(
              text: 'There shall be 10 to 12 lab exercises based on C or C++'),
          SubSection(text: 'Implementation of stack'),
          SubSection(text: 'Implementations of linear and circular queues'),
          SubSection(
              text: 'Solutions of TOH and Fibonacci sequence by Recursion'),
          SubSection(
              text:
