...
SectionHeader(text: 'Basic Methodologies of Engineering Economic Analysis [8 hours]'),
    SubSection(text: 'Determining Minimum Attractive (Acceptable) Rate of Return (MARR)'),
    ...
    SubSection(text: 'Public Sector Economic Analysis (Benefit Cost Ratio Method)'),
...
SectionHeader(text: 'Comparative Analysis of Alternatives [6 hours]'),
    SubSection(text: 'Comparing Mutually Exclusive Alternatives having Same useful life by'),
    SubSection(text: 'Payback Period Method and Equivalent Worth Method'),
    SubSection(text: 'Rate of Return Methods and Benefit Cost Ratio Method'),
    SubSection(text: 'Comparing Mutually Exclusive Alternatives having different useful lives by'),
    SubSection(text: 'Repeatability Assumption'),
    SubSection(text: 'Co‐terminated Assumption'),
    SubSection(text: 'Capitalized Worth Method'),
    SubSection(text: 'Comparing Mutually Exclusive, Contingent and Independent Projects in Combination'),
...
SectionHeader(text: 'Replacement Analysis: [6 hours]'),
    ...
    SubSection(text: 'Replacement Analysis When Required Service Life is Long'),
    SubSection(text: 'Required Assumptions and Decision Framework'),
    SubSection(text: 'Replacement Analysis under the Infinite Planning Horizon'),
    SubSection(text: 'Replacement Analysis under the Finite Planning Horizon'),
...
SectionHeader(text: 'Depreciation and Corporate Income Taxes [6 hours]'),
    ...
    SubSection(text: 'General Procedure for Making After Tax Economic Analysis'),

SectionHeader(text: 'Inflation and Its Impact on Project Cashflows. [4 hours]'),
...
SectionHeader(text: 'References:'),
    SubSection(text: 'Chan S. Park, Contemporary Engineering Economics, Prentice Hall, Inc.'),
    SubSection(text: 'E. Paul De Garmo, William G. Sullivan and James A. Bontadelli, Engineering Economy, MC Milan Publishing Company.'),
    SubSection(text: 'James L. Riggs, David D. Bedworth and Sabah U. Randhawa, Engineering Economics, Tata MCGraw Hill Education Private Limited.')
