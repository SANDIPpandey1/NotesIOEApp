...
class OperatingSystem extends StatelessWidget {
  ...
  OperatingSystem({this.initialTabIndex = 0});
  @override
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          SubSection(
              text: 'Examples of O. S.: UNIX, Linux, MS-Windows, Handheld OS.'),
          ...
          SectionHeader(
              text: 'Process Communication and Synchronization (5 hours)'),
          ...
          SubSection(
              text: 'Memory address, Swapping and Managing Free Memory Space'),
          ...
          SubSection(
              text: 'AWK tool, Search, Sort tools, Shell scripts, Make tool'),
          ...
          SubSection(
              text:
                  'Das Sumitabha, “Unix Concepts and Applications”, 3rd Edition, Tata McGraw Hill, 2003'),
          SubSection(
              text:
