...
class InternetAndIntranet extends StatelessWidget {
  ...
  InternetAndIntranet({this.initialTabIndex = 0});
  @override
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          SubSection(
              text: 'History and Development of Internets and Intranets'),
          SubSection(
              text:
          ...
          SectionHeader(
              text: 'Protocols and Client/Server Applications [6 hours]'),
          SubSection(
              text:
          ...
          SubSection(
              text:
                  'Helper applications: CGI; PERL, JAVA, JAVA SCRIPTS, PHP, ASP, .NET Applications'),
          SubSection(text: 'Introduction to AJAX (Programming)'),
          SubSection(
              text: 'browser as a rendering engine: text, HTML, gif and jpeg'),

          SectionHeader(
              text: 'Designing Internet Systems and Servers  [8 hours]'),
          ...
          SectionHeader(
              text: 'Internet and Intranet Systems Development [6 hours]'),
          ...
          SubSection(
              text: 'Content Design, Development, Publishing and Management'),
          SubSection(
              text: 'Intranet Design with Open source Tools: DRUPAL, JUMLA'),
          SubSection(text: 'Tunneling Protocols: VPN'),

          SectionHeader(text: 'Internet and Intranet Applications [6 hours]'),
          SubSection(
              text: 'General Applications: Email, WWW, Gopher, Online Systems'),
          SubSection(
              text:
          ...
          SubSection(
              text: 'Datacenters and Data warehousing, packet clearing house'),
          ...
          SubSection(
              text:
                  'Lab1: Web programming Skill (HTML, PHP, ASP..) and WEB development Tools.'),
          SubSection(
              text:
                  'Lab2, 3, 4: Web Programming with DB Connection and Ajax programming.'),
          SubSection(
              text:
                  'Lab5,6: Internet & Intranet Site Development (personal/corporate web development)'),
          SubSection(
              text:
                  'Lab 7: Web & DNS Server Installation, Configuration and Hosting.'),
          SubSection(
              text:
                  'Lab8: presentation of project work developed on lab 5, 6 & 7.'),

          SectionHeader(text: 'References'),
          SubSection(
              text: 'Computer Networks; Andrew S. Tanenbaum, Prentice Hall'),
          SubSection(
              text:
                  'Internet and Intranet Engineering; Daniel Minoli, mGraw-Hill'),
          SubSection(
              text: 'Internetworking with TCP/IP; Comer, D.E and Stevens'),
