...
SectionHeader(text: 'Forms of Ownership (2 hours)'),
    ...
    SubSection(text: 'Partnership – Types of Partners – Advantages and limitations'),
    SubSection(text: 'Joint Stock Company – Formation of Joint Stock Company – Advantages and limitations'),
    SubSection(text: 'Co – operative Societies – Types of Co – operatives – Advantages and limitations'),
    SubSection(text: 'Public Corporations – Advantages and limitations'),

SectionHeader(text: 'Organizational Structure (2 hours)'),
    SubSection(text: 'Line Organization – Advantages and dis – advantages'),
    SubSection(text: 'Functional Organization – Advantages and dis – advantages'),
    SubSection(text: 'Line and Staff Organization – Advantages and dis – advantages'),
    SubSection(text: 'Committee Organization – Advantages and dis – advantages'),
...
SectionHeader(text: 'Personal Management (8 hours)'),
    ...
    SubSection(text: 'Recruitment and Selection of manpower – Scientific selection'),
...
SectionHeader(text: 'Motivation, Leadership and Entrepreneurship (6 hours)'),
...
SectionHeader(text: 'Management Information System (5 hours)'),
    ...
    SubSection(text: 'Information Support for functional areas of management'),
    SubSection(text: 'Organizing Information Systems'),

SectionHeader(text: 'Reference Books'),
    SubSection(text: '“Industrial Engineering Handbook” , Editor – in – Chief, 4th Edition, McGraw Hill, 19xx'),
    SubSection(text: 'E. S. Buffa and R. K. Sarin “Modern Production / Operations Management”, 8th Edition, Wiley, 1987'),
    SubSection(text: 'H. J. Arnold and D. C. Feldman “Organizational Behavior” , McGraw – Hill, 1986'),
    SubSection(text: 'J. A. Senn, “Information Systems in Management ” , 4th Edition, Wadsworth Inc., 1990'),
    SubSection(text: 'P. Hershey and K. H. Blanchard, “Management of Organizational Behavior – Utilizing Human Resources ”, 4th Edition, Prentice – Hall Inc., 1982'),
    SubSection(text: 'M. Mahajan, “Industrial Engineering and production Management” ,Dhanpat Rai and Co. (P) Ltd. , Delhi, 2002'),
    SubSection(text: 'S. Sadagopan, “Management Information System”, Prentice Hall of India Pvt Ltd, 1997'),
    SubSection(text: 'C. B. Mamoria “Personnel Management”, Himalaya Publishing House – 1989'),
    SubSection(text: 'O. P. Khanna, “Industrial Engineering and Management” , Dhanpat Rai Publications (P) Ltd., 2007')
