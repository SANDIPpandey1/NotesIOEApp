...
class ObjectOrientedAnalysis extends StatelessWidget {
  ...
  ObjectOrientedAnalysis({this.initialTabIndex = 0});
  @override
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          SubSection(
              text: 'Creating Class Definitions from Design Class Diagrams'),
          ...
          SubSection(
              text:
                  'Practical: Laboratory Exercise will include handling an object oriented design and modeling activity in an ACSE Environment. UML pattern design and modeling will be taken up with the help of UML Software.'),
          ...
          SubSection(
              text:
                  'Stevens, P., Pooley, R., Using UML: Software Engineering with Objects and Components, Addison-Wesley, 2009.'),
          SubSection(
              text:
                  'Fowler, M., Scott, K., UML Distilled: Applying the Standard Object Modeling Language, Addison-Wesley, 2007.'),
          SubSection(
              text:
                  'Booch, G., Jacobson, I., Rumbaugh, J., The Unified Software Development Process, Addison-Wesley, 2009.'),
          SubSection(
              text:
                  'Booch, G., Jacobson, I., Rumbaugh, J., The Unified Modeling Language User Guide, Addison-Wesley, 2008.'),
          SubSection(
              text:
                  'Jacobson I., Object-Oriented Software Engineering – A Use Case Driven Approach, Addison-Wesley, 2009.')
        ],
      ),
    );
  }
